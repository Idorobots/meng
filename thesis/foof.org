...
- add a basic compilation diagram
...
- diagram of heterogenous platforms in a IoT setting
- diagram of heterogenous system on a homogenous platform
...
* Język =FOOF=
# Language ideology
- diagram presenting briefly how the language should work
...
- add AMP vs SMP vs heterogenous platform diagram
...
- block diagram of the system including the RBS, run queue & memory sharing
...
** Reprezentacja wiedzy w języku
- add fact store & rule store diagram
