...
- describe previous failed attempts at using an ontology
- elaborate on how this solves heterogeneity
- mention having other fun properties (can express Complex Event Processing)

** Reprezentacja wiedzy w języku
- describe fact & rule databases (briefly mention their implementation)
...
- describe facts
- add an example of some facts
- describe fact-related primops - signalling, assertion & retraction
- describe rules
- add an example of a rule listing different parts of a rule
- describe rule-related primops - adding & disabling, triggering

** Algorytm Rete
- describe Rete in detail [cite:Forgy1982]
- mention unification
- add a pseudocode of the unification algorithm?
- describe briefly its history [cite:Forgy1979]
- describe various Rete nodes [cite:Forgy1982]
...
- compare Rete with naïve approach
- add a benchmark diagram showing how Rete is better than naïve
